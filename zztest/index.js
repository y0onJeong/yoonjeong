...
// 1. 상품 데이터
const products = [
   { id: 101, name: "시그니처 울 코트", category: "outer", price: 129000, image: "img/coat.jpg", 
...
const cartModal = document.getElementById('cart-modal'); // 👈 모달 변수 선언 확인
...
// ⭐⭐⭐ 장바구니 열기 이벤트 리스너 (수정/확인 완료) ⭐⭐⭐
cartButton.addEventListener('click', () => {
    renderCartModal();
    cartModal.style.display = 'block'; // 'block'으로 변경하여 모달을 보이게 함
});
